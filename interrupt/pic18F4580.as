...
TOSU equ 0FFFh ;# 
	...
	FNCALL	_init_config,_init_external_interrupt
	FNROOT	_main
	FNCALL	intlevel2,_isr
	global	intlevel2
	FNROOT	intlevel2
	global	_key_detected
	global	_ADCON1
_ADCON1	set	0xFC1
	global	_GIE
_GIE	set	0x7F97
...
?_isr:	; 1 bytes @ 0x0
??_isr:	; 1 bytes @ 0x0
?_init_external_interrupt:	; 1 bytes @ 0x0
?_init_config:	; 1 bytes @ 0x0
?_main:	; 1 bytes @ 0x0
	ds   14
??_init_external_interrupt:	; 1 bytes @ 0xE
??_init_config:	; 1 bytes @ 0xE
??_main:	; 1 bytes @ 0xE
	global	main@wait
main@wait:	; 2 bytes @ 0xE
	ds   2
;!
;!Data Sizes:
;!    Strings     0
...
l660:
;main.c: 21: unsigned short wait;
;main.c: 23: init_config();
...
l664:
;main.c: 33: {
;main.c: 34: key_detected = 0;
	bcf	(_key_detected/8),c,(_key_detected)&7
	line	35
;main.c: 35: RB7 = !RB7;
	btfss	c:(31759/8),(31759)&7	;volatile
	goto	u31
	goto	u30
u31:
...
l668:
	decf	((c:main@wait)),c
	btfss	status,0
	decf	((c:main@wait+1)),c
		incf	((c:main@wait)),c,w
	bnz	u51
	incf	((c:main@wait+1)),c,w
	btfss	status,2
	goto	u51
	goto	u50
...
l652:
;main.c: 14: init_external_interrupt();
	call	_init_external_interrupt	;wreg free
	line	16
...
GLOBAL	__end_of_init_config
	...
	global	_init_external_interrupt
...
psect	text2
	file	"external_interrupt.c"
	line	4
	global	__size_of_init_external_interrupt
	__size_of_init_external_interrupt	equ	__end_of_init_external_interrupt-_init_external_interrupt
...
l644:
;external_interrupt.c: 6: INTEDG0 = 1;
	bsf	c:(32654/8),(32654)&7	;volatile
	line	7
;external_interrupt.c: 7: INT0F = 0;
	bcf	c:(32657/8),(32657)&7	;volatile
	line	8
;external_interrupt.c: 8: INT0E = 1;
...
l17:
	return	;funcret
	opt stack 0
GLOBAL	__end_of_init_external_interrupt
	__end_of_init_external_interrupt:
	signat	_init_external_interrupt,89
	global	_isr
...
i2l658:
;isr.c: 9: {
;isr.c: 10: key_detected = 1;
	bsf	(_key_detected/8),c,(_key_detected)&7
	line	12
;isr.c: 12: INT0F = 0;
	bcf	c:(32657/8),(32657)&7	;volatile
	goto	i2l8
