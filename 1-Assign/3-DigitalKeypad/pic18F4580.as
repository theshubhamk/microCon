...
l21:
	line	44
;main.c: 43: {
;main.c: 44: key = read_digital_keypad(1);
	movlw	(01h)&0ffh
	
	call	_read_digital_keypad
	movwf	((c:main@key)),c
	line	45
;main.c: 45: glow_on_press(key);
	movf	((c:main@key)),c,w
